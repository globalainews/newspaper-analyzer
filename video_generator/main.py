...
class VideoGenerator(VideoGeneratorBase, DataManager, UIHelpers, VideoCreator, JianyingDraftManager, TimingSynchronizer):
    ...
    def generate_prompt(self):
        ...
        # 添加风格描述
        prompt_template += """
绘制一张专业的短视频封面图片，3:4的比例，采用复古报纸评论风格。构图中心是一个手绘讽刺漫画板，具有粗犷的墨水轮廓和有限的配色（经典新闻纸奶油色、黑色墨水和点缀的红色）。漫画顶部是醒目且具有冲击力的新闻标题，使用优雅的衬线字体。纹理包含半色调网点、细微的纸张褶皱和墨水晕染效果。整体氛围尖锐、具有分析性且风趣，让人联想起经典的政治杂志封面。高对比度，适合社交媒体显示的简洁布局。画面中尽量不用文字，如果用要用中文。
"""
